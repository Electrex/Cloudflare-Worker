...
const links = [
        {
            "name": "LinkedIn",
            "url": "https://www.linkedin.com/in/yusuf-mostafa-293b83148/"
        },
        {   "name": "Github",
            "url": "https://github.com/Electrex/"
        },
        {   "name": "YouTube",
            "url": "https://www.youtube.com/channel/UCVCGOmEfk8gpyZfniHDtmCg"
        }
    ];
...
async function handleRequest(request) {
    ...
    if (url.pathname === "/links") {
        ...
        const avatar = "https://avatars1.githubusercontent.com/u/11496110?s=460&u=e8ca84c6cb7f02fe72b3761d9b1b65d8258b0e18&v=4";
        const background = "https://cdnb.artstation.com/p/assets/images/images/001/636/155/large/yakovlev-art-pylot-fanart.jpg?1449881887";
        const name = "Yusuf Mostafa";
        ...
        // const oldResult = await fetch("https://static-links-page.signalnerve.workers.dev"); // return a static web page
        return writer.transform(await fetch("https://static-links-page.signalnerve.workers.dev"))
    }
